...
class ProjectSettingsModel(ProjectSettings, QObject):
    ...
    def refresh_default_data(self):
        ...
        """
        target_gamut_options = constants.ColourSpace.get_all().copy()
        ...
        self.default_data = {
            ...
            constants.LedWallSettingsKeys.TARGET_EOTF: {
                constants.OPTIONS: constants.EOTF.get_all(), constants.DEFAULT: default_led_wall.target_eotf
            },
            ...
            constants.ProjectSettingsKeys.FILE_FORMAT: {
                constants.OPTIONS: constants.FileFormats.get_all_write(), constants.DEFAULT: constants.FileFormats.get_default() },
            constants.LedWallSettingsKeys.CALCULATION_ORDER: {
                constants.OPTIONS: constants.CalculationOrder.get_all(),
            ...
            constants.ProjectSettingsKeys.FRAME_RATE: {
                constants.DEFAULT: self.frame_rate, constants.OPTIONS: constants.FrameRates.get_all()
            },
