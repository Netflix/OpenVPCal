...
class LedWallSettings:
    ...
    def __init__(self, project_settings: "ProjectSettings", name="Wall1"):
        ...
        self._default_led_settings = {
            ...
            constants.LedWallSettingsKeys.CALCULATION_ORDER: constants.CalculationOrder.get_default(),
            constants.LedWallSettingsKeys.INPUT_PLATE_GAMUT: constants.ColourSpace.get_default_ref(),
            constants.LedWallSettingsKeys.NATIVE_CAMERA_GAMUT: constants.CameraColourSpace.get_default(),
            ...
            constants.LedWallSettingsKeys.TARGET_GAMUT: constants.ColourSpace.get_default_target(),
            constants.LedWallSettingsKeys.TARGET_EOTF: constants.EOTF.get_default(),
    ...
    def _get_property(self, field_name: str) -> Any:
